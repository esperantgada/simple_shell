...
-   By Julien Barbier
-   Project to be done in teams of 2 people (your team: Isaac Abitey, Espérant GADA
-   Ongoing project - started 10-21-2021, must end by 11-04-2021 (in 9 days) - you're done with 0% of tasks.
...
-   You can take (or fork) inspiration from [this example](https://alx-intranet.hbtn.io/rltoken/QyTR6z6CYKF6GtwGv3FeQw "this example"), but it is not mandatory to follow this format/way
-   Adopt a style and be consistent. You can, for example, follow this [style guide](https://alx-intranet.hbtn.io/rltoken/AsDNNYIFYGEybUJ6VmwViQ "style guide"). If you choose a style that already exists, add it to the `README.md` in a style section. If you write your own, create a Wiki page attached to the project and refer to it in the `README.md` style section.
    -   If you choose to use [this code](https://alx-intranet.hbtn.io/rltoken/QyTR6z6CYKF6GtwGv3FeQw "this code"), make sure to update the style accordingly
-   You should have an `AUTHORS` file, listing all individuals having contributed content to the repository. Format, see [Docker](https://alx-intranet.hbtn.io/rltoken/UL8J3kgl7HBK_Z9iBL3JFg "Docker")
